    ...
    <div className="page-enter min-h-[calc(100vh-64px)] flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Sign in to your monitoring dashboard</p>
        </div>
        <div className="glass-card p-8">
          <div className="space-y-3 mb-6">
            <button className="btn-social" onClick={() => setError('Google login coming soon. Use email/password.')}>
            ...
            <button className="btn-social" onClick={() => setError('GitHub login coming soon. Use email/password.')}>
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          Don't have an account? <Link to="/register" className="text-violet-400 hover:text-violet-300 font-medium no-underline">Create one</Link>
        </p>
      </div>
    </div>
  );
